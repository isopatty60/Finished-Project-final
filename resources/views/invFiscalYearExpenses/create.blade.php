...
@section('content')
    ...
    <div id="main">
        ...
        <div class="page-heading">
            ...
            <form action="{{ route('invFiscalYearExpenses.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" style="height:150px" name="description" placeholder="รายละอียด"></textarea>
                        </div>
                    </div>

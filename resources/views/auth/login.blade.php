        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    {{-- message --}}
                    {!! Toastr::message() !!}
                    <h1 class="auth-title">เข้าสู้ระบบ</h1>
                    <p class="auth-subtitle mb-5">เข้าสู่ระบบด้วยข้อมูลของคุณที่คุณป้อนระหว่างการลงทะเบียน</p>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="md-float-material">
                        ...
                        <button class="btn btn-primary btn-block btn-lg shadow-lg mt-5">เข้าสู้ระบบ</button>
                    </form>

...
@section('content')
    ...
    <div id="main">
        ...
        @section('content')
            ...
            <form action="{{ route('invItems.store') }}" method="POST" enctype='multipart/form-data'>
                @csrf
                ...
                <div class="col-xs-12 col-sm-12 col-md-12" hidden>
                    <div class="form-group">
                        <strong>detail_id:</strong>
                        <input type="number" name="detail_id" class="form-control" value={{ $id }}>
                    </div>
                </div>
                <br>

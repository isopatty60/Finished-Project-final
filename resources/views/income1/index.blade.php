...
@section('content')
    ...
    <div class="page-heading">
        ...
        <tr>
            <td>{{ ++$i }}</td>
            <td><a href="{{route('income2.show', $value->id)}}" class="inster" >{{ $value->name }}</a></td>
            ...
            <td>
                ...
                <a class="btn btn-primary" href="{{ route('income1.edit',$value->id) }}"><i class="bi bi-pencil-square"></i></a>
                    @csrf
                    @method('DELETE')
